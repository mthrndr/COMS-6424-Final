  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        refill_paddr = {_RANDOM[4'h1][31:19], _RANDOM[4'h2][15:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :378:31]
        counter = _RANDOM[4'h3][31:23];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        accruedRefillError = _RANDOM[4'h4][0];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:420:31]
        vb_array = {_RANDOM[4'h4][31:1], _RANDOM[4'h5], _RANDOM[4'h6][0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:420:31, :440:25]
        s2_dout_0 = {_RANDOM[4'h7][31:14], _RANDOM[4'h8][13:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26]
        s2_tl_error = _RANDOM[4'h8][15];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26, :607:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
