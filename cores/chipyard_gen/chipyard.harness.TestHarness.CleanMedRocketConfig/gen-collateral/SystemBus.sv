...
module SystemBus(
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_a_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input         auto_coupler_from_rockettile_tl_master_clock_xing_in_a_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [2:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [3:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [1:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [28:0] auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [7:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_mask,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [63:0] auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input         auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_c_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input         auto_coupler_from_rockettile_tl_master_clock_xing_in_c_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [2:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [3:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [1:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [28:0] auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [63:0] auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input         auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_rockettile_tl_master_clock_xing_in_d_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_d_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [2:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [1:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [3:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [1:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [2:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_denied,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output [63:0] auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input         auto_coupler_from_rockettile_tl_master_clock_xing_in_e_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [2:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_e_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input  [28:0] auto_coupler_from_bus_named_fbus_bus_xing_in_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output        auto_coupler_from_bus_named_fbus_bus_xing_in_d_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_bus_named_fbus_bus_xing_in_d_bits_denied,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input         auto_sbus_clock_groups_in_member_sbus_0_clock,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  wire [2:0]  _coupler_from_rockettile_auto_tl_out_a_bits_source;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:502:27]
  wire [28:0] _coupler_from_rockettile_auto_tl_out_a_bits_address;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:502:27]
  ...
  wire [2:0]  _fixer_auto_in_1_d_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  ...
  wire [2:0]  _fixer_auto_out_1_a_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  wire [28:0] _fixer_auto_out_1_a_bits_address;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  ...
  wire [28:0] _fixer_auto_out_0_a_bits_address;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  ...
  wire [2:0]  _system_bus_xbar_auto_in_1_d_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  wire        _system_bus_xbar_auto_in_1_d_bits_sink;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  ...
  wire        _system_bus_xbar_auto_in_0_d_bits_sink;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  ...
  TLXbar system_bus_xbar (	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
    ...
    .auto_out_a_ready         (auto_coupler_to_bus_named_cbus_bus_xing_out_a_ready),
    .auto_out_a_valid         (auto_coupler_to_bus_named_cbus_bus_xing_out_a_valid),
    .auto_out_a_bits_opcode   (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_opcode),
    .auto_out_a_bits_param    (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_param),
    .auto_out_a_bits_size     (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_size),
    .auto_out_a_bits_source   (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_source),
    .auto_out_a_bits_address  (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_address),
    .auto_out_a_bits_mask     (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_mask),
    .auto_out_a_bits_data     (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_data),
    .auto_out_a_bits_corrupt  (auto_coupler_to_bus_named_cbus_bus_xing_out_a_bits_corrupt),
    .auto_out_d_ready         (auto_coupler_to_bus_named_cbus_bus_xing_out_d_ready),
    .auto_out_d_valid         (auto_coupler_to_bus_named_cbus_bus_xing_out_d_valid),
    .auto_out_d_bits_opcode   (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_opcode),
    .auto_out_d_bits_param    (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_param),
    .auto_out_d_bits_size     (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_size),
    .auto_out_d_bits_source   (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_source),
    .auto_out_d_bits_sink     (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_sink),
    .auto_out_d_bits_denied   (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_denied),
    .auto_out_d_bits_data     (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_data),
    .auto_out_d_bits_corrupt  (auto_coupler_to_bus_named_cbus_bus_xing_out_d_bits_corrupt)
  );
  ...
  TLInterconnectCoupler_2 coupler_from_rockettile (	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:502:27]
    .clock                                       (_fixedClockNode_auto_out_0_clock),	// @[generators/rocket-chip/src/main/scala/prci/ClockGroup.scala:110:114]
    .reset                                       (_fixedClockNode_auto_out_0_reset),	// @[generators/rocket-chip/src/main/scala/prci/ClockGroup.scala:110:114]
    .auto_tl_master_clock_xing_in_a_ready        (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_ready),
    .auto_tl_master_clock_xing_in_a_valid        (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_valid),
    .auto_tl_master_clock_xing_in_a_bits_opcode  (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_opcode),
    .auto_tl_master_clock_xing_in_a_bits_param   (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_param),
    .auto_tl_master_clock_xing_in_a_bits_size    (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_size),
    .auto_tl_master_clock_xing_in_a_bits_source  (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_source),
    .auto_tl_master_clock_xing_in_a_bits_address (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_address),
    .auto_tl_master_clock_xing_in_a_bits_mask    (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_mask),
    .auto_tl_master_clock_xing_in_a_bits_data    (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_data),
    .auto_tl_master_clock_xing_in_a_bits_corrupt (auto_coupler_from_rockettile_tl_master_clock_xing_in_a_bits_corrupt),
    .auto_tl_master_clock_xing_in_c_ready        (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_ready),
    .auto_tl_master_clock_xing_in_c_valid        (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_valid),
    .auto_tl_master_clock_xing_in_c_bits_opcode  (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_opcode),
    .auto_tl_master_clock_xing_in_c_bits_param   (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_param),
    .auto_tl_master_clock_xing_in_c_bits_size    (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_size),
    .auto_tl_master_clock_xing_in_c_bits_source  (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_source),
    .auto_tl_master_clock_xing_in_c_bits_address (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_address),
    .auto_tl_master_clock_xing_in_c_bits_data    (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_data),
    .auto_tl_master_clock_xing_in_c_bits_corrupt (auto_coupler_from_rockettile_tl_master_clock_xing_in_c_bits_corrupt),
    .auto_tl_master_clock_xing_in_d_ready        (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_ready),
    .auto_tl_master_clock_xing_in_d_valid        (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_valid),
    .auto_tl_master_clock_xing_in_d_bits_opcode  (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_opcode),
    .auto_tl_master_clock_xing_in_d_bits_param   (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_param),
    .auto_tl_master_clock_xing_in_d_bits_size    (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_size),
    .auto_tl_master_clock_xing_in_d_bits_source  (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_source),
    .auto_tl_master_clock_xing_in_d_bits_sink    (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_sink),
    .auto_tl_master_clock_xing_in_d_bits_denied  (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_denied),
    .auto_tl_master_clock_xing_in_d_bits_data    (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_data),
    .auto_tl_master_clock_xing_in_d_bits_corrupt (auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_corrupt),
    .auto_tl_master_clock_xing_in_e_valid        (auto_coupler_from_rockettile_tl_master_clock_xing_in_e_valid),
    .auto_tl_master_clock_xing_in_e_bits_sink    (auto_coupler_from_rockettile_tl_master_clock_xing_in_e_bits_sink),
