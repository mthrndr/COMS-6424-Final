...
module ShiftQueue(
  ...
  input  [30:0] io_enq_bits_pc,	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:17:14]
  ...
  output [30:0] io_deq_bits_pc,	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:17:14]
  ...
  reg  [30:0] elts_0_pc;	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
  ...
  reg  [30:0] elts_1_pc;	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
  ...
  reg  [30:0] elts_2_pc;	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
  ...
  reg  [30:0] elts_3_pc;	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
  ...
  reg  [30:0] elts_4_pc;	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        elts_0_pc = {_RANDOM[5'h1][31:19], _RANDOM[5'h2][17:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_data = {_RANDOM[5'h2][31:18], _RANDOM[5'h3][17:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_pf_inst = _RANDOM[5'h3][20];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_gf_inst = _RANDOM[5'h3][21];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_ae_inst = _RANDOM[5'h3][22];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_replay = _RANDOM[5'h3][23];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_pc = {_RANDOM[5'h5][31:6], _RANDOM[5'h6][4:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_data = {_RANDOM[5'h6][31:5], _RANDOM[5'h7][4:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_pf_inst = _RANDOM[5'h7][7];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_gf_inst = _RANDOM[5'h7][8];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_ae_inst = _RANDOM[5'h7][9];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_replay = _RANDOM[5'h7][10];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_pc = {_RANDOM[5'h8][31:25], _RANDOM[5'h9][23:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_data = {_RANDOM[5'h9][31:24], _RANDOM[5'hA][23:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_pf_inst = _RANDOM[5'hA][26];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_gf_inst = _RANDOM[5'hA][27];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_ae_inst = _RANDOM[5'hA][28];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_replay = _RANDOM[5'hA][29];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_pc = {_RANDOM[5'hC][31:12], _RANDOM[5'hD][10:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_data = {_RANDOM[5'hD][31:11], _RANDOM[5'hE][10:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_pf_inst = _RANDOM[5'hE][13];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_gf_inst = _RANDOM[5'hE][14];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_ae_inst = _RANDOM[5'hE][15];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_replay = _RANDOM[5'hE][16];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_pc = {_RANDOM[5'hF][31], _RANDOM[5'h10][29:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_data = {_RANDOM[5'h10][31:30], _RANDOM[5'h11][29:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_pf_inst = _RANDOM[5'h12][0];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_gf_inst = _RANDOM[5'h12][1];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_ae_inst = _RANDOM[5'h12][2];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_replay = _RANDOM[5'h12][3];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
