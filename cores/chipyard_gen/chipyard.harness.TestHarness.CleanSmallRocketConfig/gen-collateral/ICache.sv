...
module ICache(
  ...
  output [28:0] auto_master_out_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input  [29:0] io_req_bits_addr,	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:248:14]
  input  [28:0] io_s1_paddr,	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:248:14]
  ...
  wire [17:0]  _tag_array_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  ...
  reg  [28:0]  refill_paddr;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:378:31]
  ...
  wire         s1_hit = _s1_vb_T_1[0] & _tag_array_0_RW0_rdata[16:0] == io_s1_paddr[28:12];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:353:40, :485:30, :500:25, :506:{26,33}, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:155:13]
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:333:25]
      ...
      s2_tl_error <= s1_hit & _tag_array_0_RW0_rdata[17];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:353:40, :510:32, :607:30, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:155:13]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_valid = _RANDOM[3'h0][4];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:333:25]
        s2_valid = _RANDOM[3'h1][3];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25]
        s2_hit = _RANDOM[3'h1][4];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :356:23]
        invalidated = _RANDOM[3'h1][5];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :359:24]
        refill_valid = _RANDOM[3'h1][6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :360:29]
        s2_request_refill_REG = _RANDOM[3'h1][9];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :377:45]
        refill_paddr = {_RANDOM[3'h1][31:10], _RANDOM[3'h2][6:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :378:31]
        counter = _RANDOM[3'h3][13:5];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        accruedRefillError = _RANDOM[3'h3][14];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:420:31, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        vb_array = {_RANDOM[3'h3][31:15], _RANDOM[3'h4], _RANDOM[3'h5][14:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:440:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        s2_dout_0 = {_RANDOM[3'h6][31:28], _RANDOM[3'h7][27:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26]
        s2_tl_error = _RANDOM[3'h7][29];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26, :607:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0_0 tag_array_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({refillError, refill_paddr[28:12]}),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:378:31, :380:33, :422:43, :427:34]
  ...
  assign auto_master_out_a_bits_address = {refill_paddr[28:6], 6'h0};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:378:31, :434:40, :761:64]
