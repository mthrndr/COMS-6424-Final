...
module IBuf(
  ...
  input  [30:0] io_imem_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  output [30:0] io_pc,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  reg  [30:0]  buf_pc;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready & _GEN_1) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13]
      buf_pc <= io_imem_bits_pc & 31'h7FFFFFFC | io_imem_bits_pc + {28'h0, _nICReady_T, 1'h0} & 31'h3;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM[2'h1][31:15], _RANDOM[2'h2][13:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_data = {_RANDOM[2'h2][31:14], _RANDOM[2'h3][13:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM[2'h3][16];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM[2'h3][17];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM[2'h3][18];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_replay = _RANDOM[2'h3][19];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
