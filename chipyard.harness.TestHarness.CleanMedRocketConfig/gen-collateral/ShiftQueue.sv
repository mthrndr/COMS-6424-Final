  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        elts_0_pc = {_RANDOM[5'h1][31:28], _RANDOM[5'h2], _RANDOM[5'h3][3:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_data = {_RANDOM[5'h3][31:4], _RANDOM[5'h4][3:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_pf_inst = _RANDOM[5'h4][6];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_gf_inst = _RANDOM[5'h4][7];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_xcpt_ae_inst = _RANDOM[5'h4][8];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_0_replay = _RANDOM[5'h4][9];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_pc = {_RANDOM[5'h6][31:1], _RANDOM[5'h7][8:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_data = {_RANDOM[5'h7][31:9], _RANDOM[5'h8][8:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_pf_inst = _RANDOM[5'h8][11];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_gf_inst = _RANDOM[5'h8][12];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_xcpt_ae_inst = _RANDOM[5'h8][13];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_1_replay = _RANDOM[5'h8][14];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_pc = {_RANDOM[5'hA][31:6], _RANDOM[5'hB][13:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_data = {_RANDOM[5'hB][31:14], _RANDOM[5'hC][13:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_pf_inst = _RANDOM[5'hC][16];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_gf_inst = _RANDOM[5'hC][17];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_xcpt_ae_inst = _RANDOM[5'hC][18];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_2_replay = _RANDOM[5'hC][19];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_pc = {_RANDOM[5'hE][31:11], _RANDOM[5'hF][18:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_data = {_RANDOM[5'hF][31:19], _RANDOM[5'h10][18:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_pf_inst = _RANDOM[5'h10][21];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_gf_inst = _RANDOM[5'h10][22];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_xcpt_ae_inst = _RANDOM[5'h10][23];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_3_replay = _RANDOM[5'h10][24];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_pc = {_RANDOM[5'h12][31:16], _RANDOM[5'h13][23:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_data = {_RANDOM[5'h13][31:24], _RANDOM[5'h14][23:0]};	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_pf_inst = _RANDOM[5'h14][26];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_gf_inst = _RANDOM[5'h14][27];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_xcpt_ae_inst = _RANDOM[5'h14][28];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
        elts_4_replay = _RANDOM[5'h14][29];	// @[generators/rocket-chip/src/main/scala/util/ShiftQueue.scala:22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
