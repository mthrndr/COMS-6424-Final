...
module Queue_10(
  ...
  input  [9:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [28:0] io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [9:0]  io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [28:0] io_deq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [121:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x122 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[19:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[48:20];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[56:49];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[120:57];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[121];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
