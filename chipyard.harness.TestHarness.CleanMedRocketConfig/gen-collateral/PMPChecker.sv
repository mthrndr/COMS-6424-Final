...
module PMPChecker(
  ...
  input  [26:0] io_pmp_0_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_0_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_1_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_1_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_2_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_2_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_3_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_3_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_4_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_4_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_5_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_5_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_6_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_6_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  input  [26:0] io_pmp_7_addr,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  input  [28:0] io_pmp_7_mask,	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:145:14]
  ...
  wire       res_hit = io_pmp_7_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_7_addr[26:1]) & ~(io_pmp_7_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_7_addr[0], 2'h0}) & ~(io_pmp_7_mask[2:0] | ~(_res_hit_lsbMask_T_1[2:0]))) == 3'h0 : io_pmp_7_cfg_a[0] & ~(io_addr[28:3] < io_pmp_6_addr[26:1] | (io_addr[28:3] ^ io_pmp_6_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_4[2:0])) < {io_pmp_6_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_7_addr[26:1] | (io_addr[28:3] ^ io_pmp_7_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_7_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned = io_pmp_7_cfg_a[1] ? (res_aligned_lsbMask & ~(io_pmp_7_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_6_addr[26:1]) == 26'h0 & io_pmp_6_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_7_addr[26:1]) == 26'h0 & io_pmp_7_addr[0] & (io_addr[2] | res_aligned_lsbMask[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:{28,55}, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_1 = io_pmp_6_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_6_addr[26:1]) & ~(io_pmp_6_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_6_addr[0], 2'h0}) & ~(io_pmp_6_mask[2:0] | ~(_res_hit_lsbMask_T_5[2:0]))) == 3'h0 : io_pmp_6_cfg_a[0] & ~(io_addr[28:3] < io_pmp_5_addr[26:1] | (io_addr[28:3] ^ io_pmp_5_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_18[2:0])) < {io_pmp_5_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_6_addr[26:1] | (io_addr[28:3] ^ io_pmp_6_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_6_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_1 = io_pmp_6_cfg_a[1] ? (res_aligned_lsbMask_1 & ~(io_pmp_6_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_5_addr[26:1]) == 26'h0 & io_pmp_5_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_6_addr[26:1]) == 26'h0 & io_pmp_6_addr[0] & (io_addr[2] | res_aligned_lsbMask_1[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_2 = io_pmp_5_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_5_addr[26:1]) & ~(io_pmp_5_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_5_addr[0], 2'h0}) & ~(io_pmp_5_mask[2:0] | ~(_res_hit_lsbMask_T_9[2:0]))) == 3'h0 : io_pmp_5_cfg_a[0] & ~(io_addr[28:3] < io_pmp_4_addr[26:1] | (io_addr[28:3] ^ io_pmp_4_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_32[2:0])) < {io_pmp_4_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_5_addr[26:1] | (io_addr[28:3] ^ io_pmp_5_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_5_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_2 = io_pmp_5_cfg_a[1] ? (res_aligned_lsbMask_2 & ~(io_pmp_5_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_4_addr[26:1]) == 26'h0 & io_pmp_4_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_5_addr[26:1]) == 26'h0 & io_pmp_5_addr[0] & (io_addr[2] | res_aligned_lsbMask_2[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_3 = io_pmp_4_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_4_addr[26:1]) & ~(io_pmp_4_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_4_addr[0], 2'h0}) & ~(io_pmp_4_mask[2:0] | ~(_res_hit_lsbMask_T_13[2:0]))) == 3'h0 : io_pmp_4_cfg_a[0] & ~(io_addr[28:3] < io_pmp_3_addr[26:1] | (io_addr[28:3] ^ io_pmp_3_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_46[2:0])) < {io_pmp_3_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_4_addr[26:1] | (io_addr[28:3] ^ io_pmp_4_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_4_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_3 = io_pmp_4_cfg_a[1] ? (res_aligned_lsbMask_3 & ~(io_pmp_4_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_3_addr[26:1]) == 26'h0 & io_pmp_3_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_4_addr[26:1]) == 26'h0 & io_pmp_4_addr[0] & (io_addr[2] | res_aligned_lsbMask_3[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_4 = io_pmp_3_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_3_addr[26:1]) & ~(io_pmp_3_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_3_addr[0], 2'h0}) & ~(io_pmp_3_mask[2:0] | ~(_res_hit_lsbMask_T_17[2:0]))) == 3'h0 : io_pmp_3_cfg_a[0] & ~(io_addr[28:3] < io_pmp_2_addr[26:1] | (io_addr[28:3] ^ io_pmp_2_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_60[2:0])) < {io_pmp_2_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_3_addr[26:1] | (io_addr[28:3] ^ io_pmp_3_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_3_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_4 = io_pmp_3_cfg_a[1] ? (res_aligned_lsbMask_4 & ~(io_pmp_3_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_2_addr[26:1]) == 26'h0 & io_pmp_2_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_3_addr[26:1]) == 26'h0 & io_pmp_3_addr[0] & (io_addr[2] | res_aligned_lsbMask_4[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_5 = io_pmp_2_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_2_addr[26:1]) & ~(io_pmp_2_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_2_addr[0], 2'h0}) & ~(io_pmp_2_mask[2:0] | ~(_res_hit_lsbMask_T_21[2:0]))) == 3'h0 : io_pmp_2_cfg_a[0] & ~(io_addr[28:3] < io_pmp_1_addr[26:1] | (io_addr[28:3] ^ io_pmp_1_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_74[2:0])) < {io_pmp_1_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_2_addr[26:1] | (io_addr[28:3] ^ io_pmp_2_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_2_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_5 = io_pmp_2_cfg_a[1] ? (res_aligned_lsbMask_5 & ~(io_pmp_2_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_1_addr[26:1]) == 26'h0 & io_pmp_1_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_2_addr[26:1]) == 26'h0 & io_pmp_2_addr[0] & (io_addr[2] | res_aligned_lsbMask_5[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_hit_6 = io_pmp_1_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_1_addr[26:1]) & ~(io_pmp_1_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_1_addr[0], 2'h0}) & ~(io_pmp_1_mask[2:0] | ~(_res_hit_lsbMask_T_25[2:0]))) == 3'h0 : io_pmp_1_cfg_a[0] & ~(io_addr[28:3] < io_pmp_0_addr[26:1] | (io_addr[28:3] ^ io_pmp_0_addr[26:1]) == 26'h0 & (io_addr[2:0] | ~(_res_hit_T_88[2:0])) < {io_pmp_0_addr[0], 2'h0}) & (io_addr[28:3] < io_pmp_1_addr[26:1] | (io_addr[28:3] ^ io_pmp_1_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_1_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{42,53,64}, :83:{16,30}, :88:5, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  ...
  wire       res_aligned_6 = io_pmp_1_cfg_a[1] ? (res_aligned_lsbMask_6 & ~(io_pmp_1_mask[2:0])) == 3'h0 : ~((io_addr[28:3] ^ io_pmp_0_addr[26:1]) == 26'h0 & io_pmp_0_addr[0] & ~(io_addr[2]) | (io_addr[28:3] ^ io_pmp_1_addr[26:1]) == 26'h0 & io_pmp_1_addr[0] & (io_addr[2] | res_aligned_lsbMask_6[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  wire [5:0] _res_hit_lsbMask_T_29 = 6'h7 << _GEN;	// @[generators/rocket-chip/src/main/scala/util/package.scala:235:71]
  wire       res_hit_7 = io_pmp_0_cfg_a[1] ? ((io_addr[28:3] ^ io_pmp_0_addr[26:1]) & ~(io_pmp_0_mask[28:3])) == 26'h0 & ((io_addr[2:0] ^ {io_pmp_0_addr[0], 2'h0}) & ~(io_pmp_0_mask[2:0] | ~(_res_hit_lsbMask_T_29[2:0]))) == 3'h0 : io_pmp_0_cfg_a[0] & (io_addr[28:3] < io_pmp_0_addr[26:1] | (io_addr[28:3] ^ io_pmp_0_addr[26:1]) == 26'h0 & io_addr[2:0] < {io_pmp_0_addr[0], 2'h0});	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:36, :63:{47,52,54,58}, :68:26, :69:{29,53,72}, :70:{28,55}, :71:16, :80:{39,52}, :81:{41,54,69}, :82:{53,64}, :83:{16,30}, :132:{8,61}, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
