  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_resp_pf_inst = _RANDOM[3'h6][20];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h6][26];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h6][30];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_speculative = _RANDOM[3'h7][1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:119:31]
        s2_replay_REG = _RANDOM[3'h7][20];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:119:31, :130:56]
        recent_progress_counter = _RANDOM[3'h7][22:21];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:119:31, :151:40]
        fq_io_enq_valid_REG = _RANDOM[3'h7][23];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:119:31, :180:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
