...
module IBuf(
  ...
  wire [1:0]   _nIC_T_2 = 2'h2 - _GEN;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:41:{16,86}]
  ...
  wire [3:0]   _valid_T = 4'h1 << (io_imem_valid ? _nIC_T_2 : 2'h0) + _GEN_0;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:40:27, :41:86, :42:25, :43:{19,45}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [1:0]   _bufMask_T_1 = (2'h1 << _GEN_0) - 2'h1;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:42:25, :75:37, :92:63, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire [1:0]   buf_replay_0 = buf_replay ? _bufMask_T_1 : 2'h0;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :40:27, :75:37, :77:23]
  wire [1:0]   ic_replay = buf_replay_0 | (io_imem_bits_replay ? _valid_T_1 & ~_bufMask_T_1 : 2'h0);	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:40:27, :74:33, :75:37, :77:23, :78:{30,35,63,65}]
  ...
  assign nReady = full_insn ? (_exp_io_rvc ? 2'h1 : 2'h2) : 2'h0;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:40:27, :41:16, :86:21, :92:63, :93:50, :102:{60,69,75}]
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready & _GEN_1) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13]
      buf_pc <= io_imem_bits_pc & 40'hFFFFFFFFFC | io_imem_bits_pc + {37'h0, _nICReady_T, 1'h0} & 40'h3;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        nBufValid = _RANDOM[3'h0][0];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:34:47]
        buf_pc = {_RANDOM[3'h1][31:24], _RANDOM[3'h2]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_data = _RANDOM[3'h3];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM[3'h4][2];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM[3'h4][3];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM[3'h4][4];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_replay = _RANDOM[3'h4][5];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
