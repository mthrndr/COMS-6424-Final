...
module TLBuffer_11(
  ...
  wire [28:0] _nodeIn_b_q_io_deq_bits_address;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  wire [7:0]  _nodeIn_b_q_io_deq_bits_mask;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  ...
  Queue nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
    .clock               (clock),
    .reset               (reset),
