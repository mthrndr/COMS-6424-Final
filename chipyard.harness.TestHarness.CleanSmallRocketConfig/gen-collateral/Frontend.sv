...
module Frontend(
  ...
  output [28:0] auto_icache_master_out_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input  [30:0] io_cpu_req_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  output [30:0] io_cpu_resp_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_0_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_0_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_1_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_1_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_2_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_2_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_3_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_3_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_4_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_4_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_5_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_5_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_6_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_6_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [26:0] io_ptw_pmp_7_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [28:0] io_ptw_pmp_7_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  input  [63:0] io_ptw_customCSRs_csrs_0_value	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
);

  wire [29:0] _io_cpu_npc_T;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:182:28]
  wire        _fq_io_enq_valid_T_6;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:180:52]
  wire [28:0] _tlb_io_resp_paddr;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:101:19]
  ...
  reg  [30:0] s1_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18]
  reg         s1_speculative;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:112:27]
  reg  [30:0] s2_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:113:22]
  ...
  wire [30:0] predicted_npc = {s1_pc[30:2], 2'h0} + 31'h4;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :124:20, :125:25]
  ...
  assign _io_cpu_npc_T = io_cpu_req_valid ? io_cpu_req_bits_pc[30:1] : s2_replay ? s2_pc[30:1] : predicted_npc[30:1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14, :113:22, :125:25, :130:46, :131:16, :182:28]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      s2_pc <= 31'h10000;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:113:22]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_pc = {_RANDOM[3'h0][31:3], _RANDOM[3'h1][1:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:103:21, :111:18]
        s1_speculative = _RANDOM[3'h1][2];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :112:27]
        s2_pc = {_RANDOM[3'h1][31:3], _RANDOM[3'h2][1:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :113:22]
        s2_tlb_resp_pf_inst = _RANDOM[3'h5][16];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h5][22];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h5][26];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_speculative = _RANDOM[3'h5][29];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24, :119:31]
        s2_replay_REG = _RANDOM[3'h6][16];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:130:56]
        fq_io_enq_valid_REG = _RANDOM[3'h6][19];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:130:56, :180:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26]
    ...
    .io_req_bits_addr               ({_io_cpu_npc_T[28:0], 1'h0}),	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :170:27, :182:28]
